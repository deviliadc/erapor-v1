...
Route::put('admin/kelas-siswa/{kelas}/update-wali', [KelasSiswaController::class, 'updateWali'])
    ->name('kelas-siswa.update-wali');
    Route::put('admin/kelas-siswa/{kelas}/generate-absen', [KelasSiswaController::class, 'generateAbsen'])
        ->name('kelas-siswa.generate-absen');
                <?php
        Route::post('admin/kelas-siswa/promote', [KelasSiswaController::class, 'promote'])
