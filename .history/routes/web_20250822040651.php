...
Route::middleware(['auth', 'checkrole:admin'])->prefix('admin')->name('admin.')->group(function () {
 ...
 Route::resource('siswa', SiswaController::class);
    ...
    // Route::get('presensi-harian/template', [PresensiHarianController::class, 'template'])->name('presensi-harian.template');
    // Route::get('presensi-harian/template/{kelas}', [PresensiHarianController::class, 'template'])
    //     ->name('presensi-harian.template');
    ...
    // Route::get('rapor/{siswa}/download', [RaporController::class, 'download'])->name('rapor.download');
