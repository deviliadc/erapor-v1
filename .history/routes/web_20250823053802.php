...
Route::middleware(['auth', 'checkrole:kepala_sekolah'])->prefix('kepala-sekolah')->name('kepala-sekolah.')->group(function () {
    ...
    Route::get('rekap-presensi', [KepalaSekolahMenuController::class, 'rekapPresensi'])->name('data-rekap-presensi.index');
    Route::get('rekap-presensi/{id}', [KepalaSekolahMenuController::class, 'rekapPresensiDetail'])
    ->name('rekap-presensi.detail');

    Route::get('nilai-mapel', [KepalaSekolahMenuController::class, 'nilaiMapel'])->name('data-nilai-mapel.index');
    
    Route::get('nilai-ekstra', [KepalaSekolahMenuController::class, 'nilaiEkstra'])->name('data-nilai-ekstra.index');
    Route::get('nilai-p5', [KepalaSekolahMenuController::class, 'nilaiP5'])->name('data-nilai-p5.index');
    Route::get('rapor', [KepalaSekolahMenuController::class, 'rapor'])->name('data-rapor.index');
});
