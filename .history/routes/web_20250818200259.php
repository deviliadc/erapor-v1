...
Route::middleware(['auth', 'checkrole:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::get('admin/kelas-mapel/{kelas}/detail', [KelasMapelController::class, 'show'])
        ->name('kelas-mapel.detail');
    ...
    Route::post('nilai-mapel/update-batch', [NilaiMapelController::class, 'updateBatch'])->name('nilai-mapel.bulk-store');
