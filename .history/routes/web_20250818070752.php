...
Route::middleware(['auth', 'checkrole:admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Route::get('/user/export', [UserController::class, 'export'])->name('user.export');
    Route::get('guru/template', [SiswaController::class, 'template'])->name('siswa.template');
    Route::get('guru/export', [SiswaController::class, 'export'])->name('siswa.export');
    Route::post('guru/import', [SiswaController::class, 'import'])->name('siswa.import');
