...
DB::table('tahun_ajaran')->insert([
            ...
            ['id' => 2, 'tahun' => '2023/2022', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 3, 'tahun' => '2022/2023', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 4, 'tahun' => '2022/2023', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 5, 'tahun' => '2023/2024', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 6, 'tahun' => '2023/2024', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 7, 'tahun' => '2024/2025', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 8, 'tahun' => '2024/2025', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 9, 'tahun' => '2025/2026', 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
            ['id' => 10, 'tahun' => '2025/2026', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        ]);
