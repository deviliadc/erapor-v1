...
class DataMasterSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        //     ['id' => 3, 'tahun' => '2023/2024', 'mulai' => '2023-07-10', 'selesai' => '2024-06-22', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     ['id' => 4, 'tahun' => '2024/2025', 'mulai' => '2024-07-08', 'selesai' => '2025-06-20', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     ['id' => 5, 'tahun' => '2025/2026', 'mulai' => '2025-07-14', 'selesai' => '2026-06-20', 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        // ]);

        // DB::table('tahun_semester')->insert([
        //     // 2021/2022
        //     ['id' => 1, 'tahun_ajaran_id' => 1, 'semester' => 'Ganjil', 'mulai' => '2021-07-12', 'selesai' => '2021-12-18', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     ['id' => 2, 'tahun_ajaran_id' => 1, 'semester' => 'Genap', 'mulai' => '2022-01-03', 'selesai' => '2022-06-25', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     // 2022/2023
        //     ['id' => 3, 'tahun_ajaran_id' => 2, 'semester' => 'Ganjil', 'mulai' => '2022-07-11', 'selesai' => '2022-12-17', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     ['id' => 4, 'tahun_ajaran_id' => 2, 'semester' => 'Genap', 'mulai' => '2023-01-02', 'selesai' => '2023-06-24', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     // 2023/2024
        //     ['id' => 5, 'tahun_ajaran_id' => 3, 'semester' => 'Ganjil', 'mulai' => '2023-07-10', 'selesai' => '2023-12-16', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     ['id' => 6, 'tahun_ajaran_id' => 3, 'semester' => 'Genap', 'mulai' => '2024-01-03', 'selesai' => '2024-06-22', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     // 2024/2025
        //     ['id' => 7, 'tahun_ajaran_id' => 4, 'semester' => 'Ganjil', 'mulai' => '2024-07-08', 'selesai' => '2024-12-21', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     ['id' => 8, 'tahun_ajaran_id' => 4, 'semester' => 'Genap', 'mulai' => '2025-01-05', 'selesai' => '2025-06-20', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        //     // 2025/2026
        //     ['id' => 9, 'tahun_ajaran_id' => 5, 'semester' => 'Ganjil', 'mulai' => '2025-07-14', 'selesai' => '2025-12-27', 'is_active' => true, 'created_at' => $now, 'updated_at' => $now],
        //     ['id' => 10, 'tahun_ajaran_id' => 5, 'semester' => 'Genap', 'mulai' => '2026-01-05', 'selesai' => '2026-06-20', 'is_active' => false, 'created_at' => $now, 'updated_at' => $now],
        // ]);
