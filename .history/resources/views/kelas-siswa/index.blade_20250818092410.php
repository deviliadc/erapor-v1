...
<x-app-layout>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
        {{-- Toolbar Table --}}
        <x-table.toolbar :enable-add-button="true" :enable-import="true" :enable-export="true" :enable-search="false" :route="role_route('kelas-siswa.index')">
            <x-slot name="addButton">
                ...
                {{-- Tombol Promosi --}}
                <button type="button" {{-- <a href="{{ route('kelas.siswa.promote', $kelas->id) }}" onclick="return confirm('Apakah Anda yakin ingin mempromosikan siswa ke kelas berikutnya?')"  </a> --}}
        ...
        ]" :data="$data" :total-count="$totalCount" row-view="kelas-siswa.partials.row"
