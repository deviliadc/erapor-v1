<x-app-layout>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
        {{-- Toolbar Table --}}
        <x-table.toolbar :enable-add-button="true" :enable-import="false" :enable-export="false" :enable-search="true" {{-- :route-create="route(role_route('kelas.create'))" --}}
            {{-- :route="role_route('kelas.mapel.index', ['kelas' => $kelas->id])"> --}} <x-slot name="addButton">
            <button type="button"
        ...
        ]" :data="$mapelList" :total-count="$totalCount" row-view="kelas.mapel.partials.row"
            :actions="[
                'detail' => true,
                'edit' => true,
                'delete' => true,
