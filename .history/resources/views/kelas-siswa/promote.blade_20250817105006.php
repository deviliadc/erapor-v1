...
<input type="hidden" name="kelas_lama_id" value="{{ $kelas->id }}">
        ...
        <div>
            ...
            <div class="w-full rounded-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-sm text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300">
                {{ $kelas->nama }}
            </div>
        </div>
