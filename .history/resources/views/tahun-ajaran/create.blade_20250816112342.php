<x-modal name="form-create-tahun" title="Tambah Tahun Pelajaran & Semester" maxWidth="2xl">
    <form action="{{ role_route('tahun-semester.store') }}" method="POST" enctype="multipart/form-data"
        ...
        {{-- Mulai --}}
        {{-- <x-form.input name="tahun_mulai" label="Tanggal Mulai" type="date" required /> --}}
        <x-form.date-picker name="tahun_mulai" label="Tanggal Mulai" required />
        {{-- Selesai --}}
        <x-form.input name="tahun_selesai" label="Tanggal Selesai" type="date" required />
