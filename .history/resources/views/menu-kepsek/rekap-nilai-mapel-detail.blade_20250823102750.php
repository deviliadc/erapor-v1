...
<x-app-layout>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
        <x-table.toolbar
            ...
            :enable-export="false"
            :enable-search="false"
            :route="role_route('kepala-sekolah.rekap-nilai-mapel.detail', ['kelas_id' => $kelas->id, 'tahun_semester_filter' => $tahunSemesterAktif->id])">
        </x-table.toolbar>

        <x-table :columns="[
            'nama' => ['label' => 'Nama', 'sortable' => true],
            'formatif' => ['label' => 'Formatif', 'sortable' => true],
            'sumatif' => ['label' => 'Sumatif', 'sortable' => true],
