        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form action="{{ role_route('siswa.update', ['siswa' => $siswa['id']]) }}" method="POST"
                ...
                <x-form.select name="agama" label="Agama" :options="[
                    ...
                    :selected="old('agama', $siswa->agama ?? null)" required />
                ...
                {{-- Kelas --}}
                <x-form.select label="Kelas" name="kelas_id" :options="$kelasOptions" :selected="old('kelas_id', $selectedKelasId)" required />
                ...
                <x-form.select label="Status" name="status" :options="['Aktif' => 'Aktif', 'Lulus' => 'Lulus', 'Keluar' => 'Keluar', 'Mutasi' => 'Mutasi']" placeholder="Pilih status"
                    :selected="old('status', $selectedStatus)" :searchable="true" required />
                <div class="px-5 py-4 sm:px-6 sm:py-5 border-b border-gray-100 dark:border-gray-800">
