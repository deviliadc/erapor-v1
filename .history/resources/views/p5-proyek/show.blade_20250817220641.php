    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow rounded-2xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <p class="text-base font-medium text-gray-800 dark:text-white">Nama Proyek</p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ $proyek->nama_proyek }}</p>
                </div>
                <div>
                    <p class="text-sm text-gray-600 dark:text-gray-400text-base font-medium text-gray-800 dark:text-white">Deskripsi</p>
                    <p class="text-sm text-gray-600 dark:text-gray-400">{{ $proyek->deskripsi }}</p>
                </div>
                {{-- <div>
                ...
                <div>
                    <p class="text-base font-medium text-gray-800 dark:text-white">Tahun Ajaran</p>
