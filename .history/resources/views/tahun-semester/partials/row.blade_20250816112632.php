...
<td class="px-4 py-3 text-gray-700 dark:text-gray-400 whitespace-nowrap min-w-[150px]">{{ $item['semester_mulai'] }}</td>
<td class="px-4 py-3 text-gray-700 dark:text-gray-400 whitespace-nowrap min-w-[150px]">{{ $item['semester_selesai'] }}</td>
<td class="px-5 py-4 sm:px-6">
    <x-badge.status :value="$item['semester_status']" />
</td>
