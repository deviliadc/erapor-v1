    ...
    <div
        ...
        <div
            ...
            @foreach ($filters as $filter)
                <x-select-filter :name="$filter['name']" :label="$filter['label']" :options="$filter['options']" :value-key="$filter['valueKey'] ?? 'id'"
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
            ...
            @endif --}}
                        {{-- filepath: d:\DEVI\DRAFT\erapor-v1\resources\views\components\table\toolbar.blade.php --}}
