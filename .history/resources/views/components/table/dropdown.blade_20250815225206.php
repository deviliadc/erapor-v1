...
<div x-data="{ open: false }" class="flex flex-wrap gap-4">
    <button @click.prevent="open = !open"
        ...
        {{ $label }}
        <svg class="stroke-current transition-transform duration-200" :class="{ 'rotate-180': open }"
            width="16" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div x-show="open" @click.outside="open = false" x-transition
        class="absolute z-20 mt-2 w-64 rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-[#1E2635]"
        style="display: none;">
