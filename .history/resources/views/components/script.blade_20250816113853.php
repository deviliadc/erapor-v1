<script>
    ...
    flatpickr(el, {
        altInput: true,
        altFormat: "d-m-Y", // tampil di form: hari-bulan-tahun
        dateFormat: "Y-m-d", // value dikirim ke server: tahun-bulan-tahun
        allowInput: true,
        defaultDate: el.value || new Date(), // default hari ini jika belum ada value
        maxDate: null // bisa pilih tanggal kapan saja
    });
});
