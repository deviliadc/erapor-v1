<x-app-layout>
    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
        ...
        <x-dashboard.card
    title="Siswa Aktif ({{ $tahunAjaranAktif && $tahunAjaranAktif->tahunAjaran ? $tahunAjaranAktif->tahunAjaran->tahun : '-' }}{{ $tahunAjaranAktif && $tahunAjaranAktif->semester ? ' - ' . $tahunAjaranAktif->semester : '' }})"
