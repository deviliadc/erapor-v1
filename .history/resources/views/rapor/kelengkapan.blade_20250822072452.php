...
<head>
    ...
    /* height: 100vh;  <- hapus ini */
    min-height: 100vh; /* opsional kalau mau konten tetap "tinggi halaman" */
}

/* Buat pengecualian: halaman terakhir jangan ada break */
.page:last-child {
...
<body onload="window.print()">
    ...
    <div class="page"
        ...
        <br><br><br><br>
        <h3>KEMENTERIAN PENDIDIKAN DAN KEBUDAYAAN RI</h3>
        <h3>{{ $sekolah->nama ?? '-' }}</h3>
...
<br><br><br><br><br><br>
        ...
        {{-- <table class="ttd">
            <tr>
                <td style="text-align:center; vertical-align:bottom; height:120px; width:150px;">
                    <div style="border:1px solid #000; width:120px; height:160px; margin:auto; display:flex; align-items:center; justify-content:center;">
                        Foto 4x3
                    </div>
                </td>

                <td style="text-align:center; vertical-align:bottom; height:160px;">
                    {{ $pengaturan->tempat ?? ($sekolah->desa ?? '-') }},
        ...
        <div style="display: flex; flex-direction: row; align-items: flex-end; margin-top: 40px; min-height: 180px;">
            <!-- Kotak Foto di kiri bawah -->
            <div style="flex: 1;">
                <div style="width:120px; height:160px; border:2px solid #222; margin-left:10px;">
                    <div style="text-align:center; font-size:12px; margin-top:65px;">Foto 3x4</div>
                </div>
            </div>
