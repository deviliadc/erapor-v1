...
<a
    @if($isValidUTS)
        href="{{ role_route('rapor.cetakTengah', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}"
        target="_blank"
    @endif
...
<a
    @if($isValidUAS)
        href="{{ role_route('rapor.cetakAkhir', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}"
        target="_blank"
    @endif
    class="rounded-lg px-4 py-3 text-sm font-medium shadow-theme-xs
...
<a
    @if($isValidP5)
        href="{{ role_route('rapor.cetakP5', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}"
        target="_blank"
    @endif
    class="rounded-lg px-4 py-3 text-sm font-medium shadow-theme-xs
