<x-app-layout>
    ...
    Kelengkapan
                            ...
                            <a href="{{ role_route('rapor.cetakTengah', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}" target="_blank"
                            ...
                            <a href="{{ role_   route('rapor.cetakAkhir', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}"
                                target="_blank"
