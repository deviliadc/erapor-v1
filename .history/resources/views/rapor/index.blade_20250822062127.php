    ...
    <form method="GET" class="mb-4 flex flex-wrap gap-4">
        ...
        <div class="flex-1 min-w-0">
            <x-form.select
                ...
                name="kelas_id"
                :options="['' => '-- Pilih Kelas --'] +
                $kelasList->mapWithKeys(fn($kls) => [$kls->id => $kls->nama])->toArray()"
                :selected="$kelas_id"
                ...
                @forelse($siswaList as $i => $siswa)
                    <tr>
                        ...
                        <td class="px-3 py-2 flex flex-wrap gap-2 justify-center">
                            ...
                            <a href="{{ route('rapor.cetakKelengkapan', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}"
    target="_blank"
    class="px-4 py-3 text-sm font-medium text-white rounded-lg bg-warning-500 shadow-theme-xs hover:bg-warning-600">
    Kelengkapan
</a>
                            ...
                            <a href="{{ route('rapor.cetakTengah', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}" target="_blank"
                            ...
                            <a href="{{ route('rapor.cetakAkhir', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}"
                                target="_blank"
                            ...
                            <a href="{{ route('rapor.cetakP5', ['siswa' => $siswa->id, 'tahun_semester_id' => $tahunSemesterId]) }}"
                                target="_blank"
