...
// Reset proyek jika tahun semester berubah
if ($request->has('tahun_semester_id') && $request->filled('tahun_semester_id')) {
    // Jika user memilih tahun semester baru, proyek harus direset
    $proyekId = null;
} else {
    // Saat awal buka, ambil proyek pertama di tahun semester aktif
