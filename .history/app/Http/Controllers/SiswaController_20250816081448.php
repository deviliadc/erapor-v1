...
class SiswaController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        $riwayatKelas = KelasSiswa::with(['kelas', 'tahunSemester'])
            ->where('siswa_id', $siswa->id)
            ->orderByDesc('tahun_semester_id')
            ->get()
            ->map(function ($item, $idx) {
                return [
                    ...
                    'tahun' => $item->tahunSemester ? $item->tahunSemester->tahunAjaran->tahun . ' ' . $item->tahunSemester->semester : '-',
