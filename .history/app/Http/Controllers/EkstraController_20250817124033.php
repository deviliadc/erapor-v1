...
class EkstraController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $ekstra = $this->getEkstraData($request, $perPage, $tahunAjaranId);
        ...
        return view('ekstrakurikuler.index', array_merge(
            ...
            $this->getEkstraData($request, $perPage, $tahunAjaranId),
            $this->getParameterData($request, $perPage),
        ));
    }

    private function getEkstraData(Request $request, $perPage, $tahunSemesterId)
    {
