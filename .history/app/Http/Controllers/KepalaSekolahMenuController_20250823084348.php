    ...
    public function nilaiEkstraDetail(Request $request, $kelas_id)
    {
        ...
        foreach ($kelasSiswaList as $ks) {
            ...
            $nilaiEkstra[] = [
                ...
                'no_absen' => $ks->no_absen,
                'nama' => $ks->siswa->nama ?? '-',
                'nilai' => $nilai->first()?->nilai_akhir ?? '-', // ambil item pertama
                'deskripsi' => $nilai->first()?->deskripsi ?? '-',
        ...
        return view('menu-kepsek.rekap-nilai-ekstra-detail', [
            ...
            'breadcrumbs' => [['label' => 'Rekap Nilai Ekstrakurikuler',  'url' => route('kepala-sekolah.nilai-ekstra.detail')],
