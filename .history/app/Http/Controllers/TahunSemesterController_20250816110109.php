...
class TahunSemesterController extends Controller
{
    ...
    private function getTahunAjaranData(Request $request, $perPage)
    {
        ...
        return compact('tahunAjaran', 'totalCount');
    }
    ...
    private function getTahunSemesterData(Request $request, $perPage)
    {
        ...
        $tahunOptions = TahunAjaran::all()->pluck('tahun', 'id')->toArray();
        return view('tahun-semester.index', compact('title', 'breadcrumbs', 'tahunOptions', 'tahunSemester'));
    }
