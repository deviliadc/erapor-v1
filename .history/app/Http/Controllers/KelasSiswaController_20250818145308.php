...
$guruList = Guru::orderBy('nama')->pluck('nama', 'id')->toArray();
    ...
    public function store(Request $request, string $kelas)
    {
        ...
        rn redirect()->to(role_route('kelas-siswa.show', ['kelas' => $kelas, 'tahun_ajaran_filter' => $tahunAjaranId]))
            ->wretuith('success', 'Siswa berhasil ditambahkan ke kelas.');
    }
    ...
    public function update(Request $request, string $kelas, string $id)
    {
        ...
        $tahunAjaranId = $request->input('tahun_ajaran_filter');
        return redirect()->to(role_route('kelas-siswa.show', [
            'kelas' => $kelas,
