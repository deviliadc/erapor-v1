...
class NilaiP5Controller extends Controller
{
    ...
    $nilaiMap = [];
        ...
        // Jika tahun semester berubah, reset proyek
        if ($request->has('tahun_semester_id') && !$request->has('proyek_id')) {
            // Tahun semester dipilih, tapi proyek belum dipilih, reset ke null
            $proyekId = null;
        } else {
            // Jika proyek dipilih, pakai proyek dari request, jika tidak, pakai proyek pertama
