...
class GuruController extends Controller
{
    ...
    {
        return response()->download(public_path('templates/guru_template.xlsx'));
    }
    ...
    public function import(Request $request)
    {
        ...
        try {
            ...
            return redirect()->to(role_route('guru.index'))->with('success', 'Data guru berhasil diimpor.');
        } catch (\Exception $e) {
            return back()->withErrors('Gagal mengimpor data guru: ' . $e->getMessage());
        }
    }
