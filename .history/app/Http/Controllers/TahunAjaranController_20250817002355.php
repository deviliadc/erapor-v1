    ...
    public function update(Request $request, string $id)
{
    ...
    if ($isActive) {
        ...
        if ($semesterGanjil) {
            ...
            // Kalau tidak ada semester, nonaktifkan semua tahun semester
            TahunSemester::where('tahun_ajaran_id', $item->id)->update(['is_active' => false]);
        }
    }
