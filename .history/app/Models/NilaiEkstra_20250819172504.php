...
class NilaiEkstra extends Model
{
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($nilai) {
            // Ambil id dari atribut, bukan relasi
            $kelasSiswa = \App\Models\KelasSiswa::find($nilai->kelas_siswa_id);
            $tahunSemester = \App\Models\TahunSemester::find($nilai->tahun_semester_id);
