...
class KelasMapelController extends Controller
{
    ...
    public function index(Request $request,  string $kelas)
    {
        ...
        return view('kelas.mapel.index', compact('kelas', 'mapel', 'mapelList', 'title', 'breadcrumbs', 'tahunAktif', 'guruSelect', 'mapelSelect', 'totalCount'));
    }
    /**
    ...
    public function create(string $kelas)
    {
        ...
        return view('kelas.mapel.create', compact('kelas', 'title', 'breadcrumbs', 'guruSelect', 'mapelSelect'));
    }
    ...
    public function store(Request $request, string $kelas)
    {
        ...
        return redirect()->route('kelas.mapel.index', $kelas)->with('success', 'Mapel berhasil ditambahkan.');
    }
    ...
    public function edit(string $kelas, string $id)
    {
        ...
        return view('kelas.mapel.edit', compact('kelas', 'guruKelas', 'title', 'breadcrumbs', 'guruSelect', 'mapelSelect'));
    }
