...
Route::middleware(['auth', 'checkrole:kepala_sekolah'])->prefix('kepala-sekolah')->name('kepala-sekolah.')->group(function () {
    Route::get('dashboard', [DashboardController::class, 'index'])->name('dashboard');
    Route::resource('guru', GuruController::class);
    Route::resource('siswa', SiswaController::class);
    Route::get('data-guru', [KepalaSekolahMenuController::class, 'dataGuru'])->name('data-guru.index');
    Route::get('data-siswa', [KepalaSekolahMenuController::class, 'dataSiswa'])->name('data-siswa.index');
    // Route::get('data-wali-murid', [KepalaSekolahMenuController::class, 'dataWaliMurid'])->name('data-wali-murid.index');
    Route::get('rekap-presensi', [KepalaSekolahMenuController::class, 'rekapPresensi'])->name('rekap-presensi.index');
    Route::get('rekap-presensi/{id}', [KepalaSekolahMenuController::class, 'rekapPresensiDetail'])
    ->name('rekap-presensi.detail');

    Route::get('nilai-mapel', [KepalaSekolahMenuController::class, 'nilaiMapel'])->name('nilai-mapel.index');
Route::get('rekap-presensi/{id}', [KepalaSekolahMenuController::class, 'rekapPresensiDetail'])
    ->name('rekap-presensi.detail');
    Route::get('nilai-mapel/{id}', [KepalaSekolahMenuController::class, 'nilaiMapelDetail'])
        ->name('nilai-mapel.detail');
    Route::get('nilai-ekstra', [KepalaSekolahMenuController::class, 'nilaiEkstra'])->name('nilai-ekstra.index');
    Route::get('nilai-ekstra/{id}', [KepalaSekolahMenuController::class, 'nilaiEkstraDetail'])
    ->name('nilai-ekstra.detail');

    Route::get('nilai-p5', [KepalaSekolahMenuController::class, 'nilaiP5'])->name('nilai-p5.index');
    Route::get('nilai-p5/{id}', [KepalaSekolahMenuController::class, 'nilaiP5Detail'])
    ->name('nilai-p5.detail');

    // Route::get('rapor', [KepalaSekolahMenuController::class, 'rapor'])->name('rapor.index');
});
