...
<x-app-layout>
    ...
    <div class="rounded-2xl border border-gray-200 bg-white pt-4 dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <x-table.toolbar :filters="$filters" :enable-add-button="true" :enable-import="false" :enable-export="false" :enable-search="true"
            {{-- :route-create="route(role_route('kelas.create'))" --}} {{-- :route="route('kelas-mapel.index', ['kelas' => $kelas->id])" --}}>
        ...
        ]" :data="$mapelList" :total-count="$totalCount" row-view="mapel-kelas.partials.row-detail"
            :actions="[
                'edit' => true,
                'delete' => true,
                'routes' => [
