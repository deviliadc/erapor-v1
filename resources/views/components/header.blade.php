    ...
    <div class="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div
            ...
            <button
                ...
                :class="$store.sidebar.toggle ? 'lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800' : ''"

                class="z-[99999] flex h-10 w-10 items-center justify-center rounded-lg border-gray-200 text-gray-500 lg:h-11 lg:w-11 lg:border dark:border-gray-800 dark:text-gray-400"
                {{-- @click.stop="sidebarToggle = !sidebarToggle" --}}
                @click="$store.sidebar.toggle = !$store.sidebar.toggle">
                ...
                <svg :class="$store.sidebar.toggle ? 'hidden' : 'block lg:hidden'" class="fill-current lg:hidden" width="24"
                ...
                <svg :class="$store.sidebar.toggle ? 'block lg:hidden' : 'hidden'" class="fill-current" width="24"
            ...
            <a href="index.html" class="lg:hidden">
                <img class="h-8 w-8 dark:hidden" src="{{ asset('images/logo-app.png') }}" alt="Logo" />
                <img class="h-8 w-8 hidden dark:block" src="{{ asset('images/logo-app.png') }}" alt="Logo" />
            </a>
            ...
            <div :class="menuToggle ? 'flex' : 'hidden'"
                ...
                <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                    <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                        ...
                        <span
                            class="mr-3 h-11 w-11 rounded-full border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-gray-500 dark:text-gray-400 flex items-center justify-center hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-700 dark:hover:text-white transition-colors">
                            ...
                            @else
                                <svg class="w-6 h-6 stroke-current" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M4 21C4 17 8 15 12 15C16 15 20 17 20 21" stroke-width="2"
