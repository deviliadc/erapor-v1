...
<x-sidebar-item :items="[
    ...
    'USERS' => [
        [
            ...
            'children' => [
                ['label' => 'User', 'route' => route('user.index')],
                ['label' => 'Guru & Tenaga Kerja', 'route' => route('guru.index')],
                ['label' => 'Siswa', 'route' => route('siswa.index')],
            ],
        ],
    ],
    'KURIKULUM' => [
        ...
        [
            ...
            'children' => [
                ['label' => 'Mata Pelajaran', 'route' => route('mapel.index')],
                ['label' => 'Bab', 'route' => route('bab.index')],
                ['label' => 'Lingkup Materi', 'route' => route('lingkup-materi.index')],
                ['label' => 'Tujuan Pembelajaran', 'route' => route('tujuan-pembelajaran.index')],
            ],
        ],
        [
            ...
            'children' => [
                ['label' => 'Ekstrakurikuler', 'route' => route('ekstra.index')],
                // ['label' => 'Parameter Ekstra', 'route' => route('param-ekstra.index')],
            ],
        ],
        [
            'label' => 'Kelola P5',
            ...
            'children' => [
                ['label' => 'P5', 'route' => route('p5.index')],
                // ['label' => 'Dimensi', 'route' => route('dimensi.index')],
            ],
        ],
    ],
    'PENILAIAN' => [
        [
            ...
            'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 24 24\' stroke-width=\'1.5\' stroke=\'currentColor\' class=\'w-6 h-6\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' d=\'M5.25 4.5h13.5m-13.5 4.5h13.5m-13.5 4.5h13.5m-13.5 4.5h13.5\' /></svg>',
        ],
        [
            'label' => 'Nilai Mata Pelajaran',
            'route' => route('nilai-mapel.index'),
        ...
        [
            ...
            'route' => route('nilai-ekstra.index'),
        ...
        [
            'label' => 'Nilai P5',
            'route' => route('nilai-p5.index'),
            'icon' => '<svg xmlns=\'http://www.w3.org/2000/svg\' fill=\'none\' viewBox=\'0 0 24 24\' stroke-width=\'1.5\' stroke=\'currentColor\' class=\'w-6 h-6\'><path stroke-linecap=\'round\' stroke-linejoin=\'round\' d=\'M4.5 12.75l6 6 9-13.5\' /></svg>',
        ],
    ],
    'RAPOR' => [
        [
            'label' => 'Rapor Siswa',
            'route' => route('rapor.index'),
