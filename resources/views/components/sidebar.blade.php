<aside
    ...
    class="sidebar fixed left-0 top-0 z-50 flex h-screen w-[290px] flex-col overflow-y-hidden border-r border-gray-200 bg-white px-5 transition-all duration-300 dark:border-gray-800 dark:bg-black lg:static lg:translate-x-0">
    ...
    <div class="pt-8 pb-7 px-4">
        <a href="{{ route('admin.dashboard') }}" class="flex items-center">
            ...
            <span
                class="ml-3 text-lg font-semibold text-gray-800 dark:text-white transition-all duration-300"
    ...
    <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        ...
        <svg :class="page === 'Profile' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
            ...
            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="menu-item-text" :class="sidebarToggle ? 'hidden lg:block' : 'inline-block'">
                                User Profile
                            </span>
                        </a>
                    </li>
