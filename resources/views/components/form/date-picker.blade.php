...
<div>
    ...
    <div class="relative">
        <input
            ...
            data-default-date="{{ old($name, $value) ?: ($name === 'tanggal' ? now()->format('Y-m-d') : '') }}"
        />

        <span class="absolute text-gray-500 -translate-y-1/2 right-3 top-1/2 dark:text-gray-400 pointer-events-none">
