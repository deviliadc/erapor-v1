<x-modal name="form-create-lingkup-materi" title="Tambah Lingkup Materi" maxWidth="2xl">
    <form action="{{ role_route('lingkup-materi.store') }}" method="POST" enctype="multipart/form-data"
        ...
        {{-- Lingkup Materi --}}
        <x-form.textarea label="Lingkup Materi" name="nama" :value="old('nama')" required />
