        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form action="{{ route('admin.siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data"
                ...
                <x-form.select label="Jenis Kelamin" name="jenis_kelamin" :options="['Laki-laki' => 'Laki-laki', 'Perempuan' => 'Perempuan']"
                    placeholder="Pilih jenis kelamin" :selected="old('jenis_kelamin', $siswa->jenis_kelamin)" />
                ...
                <x-form.input label="Pendidikan Sebelumnya" name="pendidikan_sebelum" :value="old('pendidikan_sebelum', $siswa->pendidikan_sebelum)" />

                {{-- Alamat --}}
                <x-form.input label="Alamat" name="alamat" :value="old('alamat', $siswa->alamat)" />
