        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <form action="{{ role_route('siswa.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <x-form.select label="Jenis Kelamin" name="jenis_kelamin" :options="['Laki-laki' => 'Laki-laki', 'Perempuan' => 'Perempuan']"
                    placeholder="Pilih jenis kelamin" :selected="old('jenis_kelamin')" :searchable="true" required />
                ...
                <x-form.select name="agama" label="Agama" :options="[
                    ...
                    'Buddha' => 'Buddha',
                    'Konghucu' => 'Konghucu',
                ]" placeholder="Pilih agama" required />
                ...
                {{-- Kelas --}}
                <x-form.select label="Kelas" name="kelas_id" :options="$kelasOptions" placeholder="Pilih kelas"
                    :selected="old('kelas_id')" :searchable="true" required />
                ...
                <x-form.select label="Status" name="status" :options="['Aktif' => 'Aktif', 'Lulus' => 'Lulus', 'Keluar' => 'Keluar', 'Mutasi' => 'Mutasi']" placeholder="Pilih status"
                    :selected="old('status')" :searchable="true" required />
