...
<x-app-layout>
    ...
    <!-- Wrapper -->
    <div class="rounded-2xl bg-white dark:border-gray-800 dark:bg-white/[0.03] p-3">
    <div class="space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700 dark:text-white/90">
                        ...
                        <div><strong>No HP Wali:</strong> {{ $siswa->no_hp ?? '-' }}</div>
                        <div><strong>Alamat Wali:</strong> {{ $siswa->alamat }}</div>
                    </div>
                </div>
            </div>
