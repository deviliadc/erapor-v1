<x-modal name="form-create-p5-subelemen" title="Tambah P5 Sub Elemen" maxWidth="2xl">
    <form action="{{ role_route('p5-subelemen.store', ['tab' => request('tab', 'subelemen')]) }}" method="POST" enctype="multipart/form-data"
        ...
        <x-form.input
            ...
            type="text"
            placeholder="Masukkan nama sub elemen"
            required/>

        {{-- Deskripsi Sub Elemen --}}
        {{-- <x-form.textarea
            id="deskripsi_sub_elemen"
            name="deskripsi_sub_elemen"
            label="Deskripsi Sub Elemen"
            placeholder="Masukkan deskripsi sub elemen"
            rows="4"
