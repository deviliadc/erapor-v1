...
<x-app-layout>
    ...
    <div x-data="{
        ...
        @else
            ...
            <form action="{{ role_route('nilai-mapel.bulk-store') }}" method="POST">
                @csrf
                                ...
                                <table class="min-w-[1200px] w-full text-sm text-center table-auto whitespace-nowrap">
                                    <thead class="text-gray-700 bg-gray-100 dark:bg-gray-800 dark:text-gray-200">
                                        <tr>
                                            ...
                                            @endif
                                            {{-- @if ($periode == 'tengah')
                                                <th rowspan="2" class="px-3 py-2 bg-blue-light-50">Nilai Tengah Semester</th>
                                            @endif
                                            @if ($periode == 'akhir')
                                                <th rowspan="2" class="px-3 py-2 bg-blue-light-50">Nilai Akhir Semester</th>
                                            @endif --}}
                                    ...
                                    <tbody class="bg-white dark:bg-gray-900">
                                        @forelse ($siswaList as $item)
                                            @php
                                                ...
                                                //     $val =
                                                //         old("nilai.$ksId.formatif_$tp->id") ??
                                                //         ($nilaiMapelTab['formatif'][$ksId][$tp->id] ?? null);
                                                //     $nilaiFormatif->push(is_numeric($val) ? (float) $val : null);
                                                // }
                                                ...
                                                //     $val =
                                                //         old("nilai.$ksId.sumatif_$babKey") ??
                                                //         ($nilaiMapelTab['sumatif'][$ksId][$babKey] ?? null);
                                                //     $nilaiSumatif->push(is_numeric($val) ? (float) $val : null);
                                                // }

                                                // // UTS/UAS
                                                // $tesUTS =
                                                //     old("nilai.$ksId.uts_tes") ??
                                                //     ($nilaiMapelTab['uts'][$ksId]['tes'] ?? null);
                                                // $nonTesUTS =
                                                //     old("nilai.$ksId.uts_nontes") ??
                                                //     ($nilaiMapelTab['uts'][$ksId]['non_tes'] ?? null);
                                                // $tesUAS =
                                                //     old("nilai.$ksId.uas_tes") ??
                                                //     ($nilaiMapelTab['uas'][$ksId]['tes'] ?? null);
                                                // $nonTesUAS =
                                                //     old("nilai.$ksId.uas_nontes") ??
                                                ...
                                                //     ->filter()
                                                //     ->avg();
                                                // $nilaiAkhir = $periode == 'tengah' ? $naUTS : $naUAS;
                                            @endphp
                                            <tr>
                                                ...
                                                <td class="bg-success-50">
                                                    {{ $naFormatif !== null ? round($naFormatif, 2) : '-' }}
                                                </td>
                                                {{-- Sumatif --}}
                                                ...
                                                <td class="bg-warning-50">
                                                    {{ $naSumatif !== null ? round($naSumatif, 2) : '-' }}
                                                </td>
                                                {{-- UTS --}}
                                                {{-- <td>
                                                    @if ($periode == 'tengah')
                                                    ...
                                                    @else
                                                        <span>{{ is_null($nonTesUTS) || $nonTesUTS === '' ? '-' : $nonTesUTS }}</span>
                                                    @endif
                                                </td>
                                                <td>
                                                    @if ($periode == 'tengah')
                                                    ...
                                                    @else
                                                        <span>{{ is_null($tesUTS) || $tesUTS === '' ? '-' : $tesUTS }}</span>
                                                    @endif
                                                </td> --}}
                                                <td>
                                                    @if ($periode == 'tengah')
                                                    ...
                                                    @else
                                                        {{-- Readonly hidden input to preserve data --}}
                                                        <input type="hidden"
                                                            name="nilai[{{ $ksId }}][uts_nontes]"
                                                            value="{{ $nonTesUTS }}">
                                                        <span>{{ is_null($nonTesUTS) || $nonTesUTS === '' ? '-' : $nonTesUTS }}</span>
                                                ...
                                                @if ($periode == 'akhir')
                                                    ...
                                                    <td class="bg-error-50">
                                                        {{ $naUAS !== null ? round($naUAS, 2) : '-' }}
                                                    </td>
                                                    <td class="bg-indigo-50 font-bold">
                                                        {{ $nilaiAkhir !== null ? round($nilaiAkhir, 2) : '-' }}
                                                    </td>
                                                @endif
                                            </tr>
                                        @empty
